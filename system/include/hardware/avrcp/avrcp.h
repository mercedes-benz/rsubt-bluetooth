...
class MediaCallbacks {
 public:
  virtual void SendMediaUpdate(bool track_changed, bool play_state,
                               bool queue) = 0;
  virtual void SendMediaUpdateWithAddress(bool track_changed, bool play_state,
                                bool queue, const RawAddress& address) = 0;
  ...
  virtual uint16_t GetDelayReportWithAddress(const RawAddress& address) = 0;
...
class MediaInterface {
 public:
  ...
  virtual void SendKeyEventWithAddress(uint8_t key, KeyState state, const RawAddress& address) = 0;
  // @}
  ...
  using PlayStatusWithAddressCallback = base::Callback<void(PlayStatus status, const RawAddress& address)>;
  virtual void GetPlayStatusWithAddress(PlayStatusWithAddressCallback status_cb, const RawAddress& address) = 0;
  ...
  virtual void SendDelayReportEventWithAddress(const RawAddress& address, uint16_t delay_report) = 0;
...
class VolumeInterface {
 public:
  ...
  virtual void SetVolumeWithAddress(int8_t volume, const RawAddress& bdaddr) = 0;
