...
typedef enum {
  ...
  // APRICOT-404996: get local manufacturer @{
  /**
    * Description - Local Adapter manufacturer
    * Access mode - Only GET
    * Data type   - uint32_t
    */
  BT_PROPERTY_LOCAL_MANUFACTURER,
  // @}

  // APRICOT-522983: get volume control feature @{
  /**
    * Description - True if Remote supports HFP volume control.
    * Access mode - Only GET
    * Data type   - bool
    */
  BT_PROPERTY_REMOTE_HFP_IS_SUPPORT_VOLUME_CONTROL,
  // @}

  // APRICOT-522983: get volume control feature @{
  /**
    * Description - True if Remote supports AVRCP volume control.
    * Access mode - Only GET
    * Data type   - bool
    */
  BT_PROPERTY_REMOTE_AVRCP_IS_SUPPORT_VOLUME_CONTROL,
  // @}
