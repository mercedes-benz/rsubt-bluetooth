...
class AvrcpService : public MediaCallbacks {
 public:
  ...
  void SendMediaUpdate(bool track_changed, bool play_state,
                       bool queue) override;
  void SendMediaUpdateWithAddress(bool track_changed, bool play_state,
                       bool queue, const RawAddress& address) override;
  ...
  uint16_t GetDelayReportWithAddress(const RawAddress& address) override;
